...
namespace App1
{
    class Emprunt
    {
        ...
        public Emprunt(double _tauxInteretAnnuel,int _nbrAnneeRbmt, double _capitalEmprunte)
        {
        ...
        public Emprunt(int _idMois, double lol1, double lol2, double lol3, double lol4)
        {
            I = _idMois;
            PartInteret = lol2;
            PartCapital = lol1;
